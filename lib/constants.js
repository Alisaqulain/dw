export const SITE_LOGO = "/logocorrect.png";

export const STORE_CONTACT = {
  email: "trustsilicon95@gmail.com",
  phones: [
    { display: "+91 81712 14737", tel: "+918171214737", whatsapp: "918171214737" },
    { display: "+91 78306 56594", tel: "+917830656594", whatsapp: "917830656594" },
  ],
  whatsapp: "918171214737",
  instagram: "https://www.instagram.com/trust_silicon_/",
  instagramHandle: "@trust_silicon_",
};

export const COLLECTIONS = [
  { label: "For Him", slug: "for-him", href: "/shop?collection=For%20Him", icon: "👨", desc: "Premium wellness crafted for men" },
  { label: "For Her", slug: "for-her", href: "/shop?collection=For%20Her", icon: "👩", desc: "Body-safe comfort for her" },
  { label: "Couple Wellness", slug: "couple", href: "/shop?collection=Couple%20Wellness", icon: "💑", desc: "Shared wellness experiences" },
  ...
  { label: "Lubes & Accessories", slug: "lubes", href: "/shop?collection=Lubes%20%26%20Accessories", icon: "💧", desc: "Care essentials & accessories" },
  { label: "Gift Combos", slug: "gifts", href: "/shop?collection=Gift%20Combos", icon: "🎁", desc: "Curated gift sets" },
  { label: "Starter Kits", slug: "starter", href: "/shop?collection=Starter%20Kits", icon: "📦", desc: "Perfect for first-timers" },
];

export const CATEGORY_TILES = [
  { label: "For Him", href: "/shop?collection=For%20Him", gradient: "from-sky-500 via-blue-600 to-indigo-700", glow: "shadow-sky-400/40", icon: "👨", desc: "Premium wellness crafted for men" },
  { label: "For Her", href: "/shop?collection=For%20Her", gradient: "from-cyan-400 via-sky-500 to-blue-600", glow: "shadow-cyan-400/40", icon: "👩", desc: "Body-safe comfort designed for her" },
  { label: "Couple Wellness", href: "/shop?collection=Couple%20Wellness", gradient: "from-violet-500 via-indigo-600 to-blue-700", glow: "shadow-violet-400/40", icon: "💑", desc: "Shared experiences for two" },
  { label: "Starter Kits", href: "/shop?collection=Starter%20Kits", gradient: "from-teal-400 via-cyan-500 to-sky-600", glow: "shadow-teal-400/40", icon: "📦", desc: "Perfect for first-timers" },
  { label: "Combos", href: "/shop?collection=Gift%20Combos", gradient: "from-fuchsia-500 via-violet-600 to-indigo-700", glow: "shadow-fuchsia-400/40", icon: "🎁", desc: "Curated gift sets & bundles" },
];
