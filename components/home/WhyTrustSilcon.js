    ...
    <section className="bg-white py-12 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <RevealSection className="text-center">
          <span className="text-xs font-bold uppercase tracking-widest text-sky-500">Why TrustSilcon</span>
          <h2 className="mt-2 text-2xl font-bold text-slate-900 sm:text-3xl">Built on Trust, Designed for You</h2>
          <p className="mx-auto mt-3 max-w-2xl text-slate-500">Every product meets our strict quality standards for safety, comfort, and discretion.</p>
        </RevealSection>
