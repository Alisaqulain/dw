...
function ReviewsContent() {
  ...
  const [form, setForm] = useState({ name: "", rating: 5, review: "", orderNumber: searchParams.get("order") || "" });
  ...
  const handleSubmit = async (e) => {
    ...
    if (res.ok) {
      ...
      setForm({ name: "", rating: 5, review: "", orderNumber: "" });
    } else {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <p className="mt-2 text-slate-500">Share your TrustSilcon experience</p>

      <form onSubmit={handleSubmit} className="mt-8 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-sky-100">
