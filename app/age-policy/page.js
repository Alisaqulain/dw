...
export default function AgePolicyPage() {
  return (
    <PolicyLayout title="Age Verification Policy">
      <p>TrustSilcon sells adult intimate wellness products intended exclusively for individuals aged 21 years and above.</p>
      <h2 className="text-lg font-bold text-slate-800">Age Requirement</h2>
      <p>By accessing this website and placing an order, you confirm that you are at least 21 years of age and of legal age to purchase adult wellness products in your jurisdiction.</p>
      ...
      <h2 className="text-lg font-bold text-slate-800">Under 21</h2>
      <p>If you are under 21, you must not access or use this website. Clicking &ldquo;I am under 21&rdquo; will redirect you away from our site.</p>
